      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <img src={logo} alt="Global Visa Connect" className="footer-logo" />
            <p>Your trusted partner for immigration success. ICCRC & MARA registered consultants.</p>
            <div className="footer-social">
              <a href="https://wa.me/918699078400" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              ...
              <a href="tel:+918699078400" aria-label="Call">
              ...
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=Info@globalvisaconnect.in" target="_blank" rel="noopener noreferrer" aria-label="Email">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>📧 <a href="https://mail.google.com/mail/?view=cm&fs=1&to=Info@globalvisaconnect.in" target="_blank" rel="noopener noreferrer">Info@globalvisaconnect.in</a></li>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Global Visa Connect. All rights reserved.</p>
