...
const stages = [
  ...
  },
  {
    ...
    desc: 'A deep-dive assessment of your qualifications, experience, language scores and immigration history to identify the strongest pathway.',
    icon: '🔍',
...
const faqs = [
  { q: 'How long does the entire process take?', a: 'It depends on the visa type and country. Student visas typically take 8–14 weeks, and PR applications 6–18 months. We give you a written timeline at your consultation.' },
  { q: 'What documents do I need to start?', a: 'Typically: passport, educational certificates, experience letters, language test scores and financial statements. Your case manager will give you a personalised checklist.' },
